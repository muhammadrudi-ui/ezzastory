...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            <form action="<?= base_url('portofolio/update/1'); ?>" method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-6">
                        <label class="fw-bold">Nama Mempelai</label>
                        <input type="text" name="nama_mempelai" class="form-control" value="Jhon & Anne" required>
                    </div>
                    <div class="col-md-6">
                        <label class="fw-bold">Foto</label>
                        <input type="file" name="foto" class="form-control"
                            onchange="previewImage(event, 'previewFoto')">
                        <img id="previewFoto" src="/IMG/foto.jpg" alt="Foto" class="mt-2" width="100">
                    </div>
                </div>
